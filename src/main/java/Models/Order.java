...
public class Order {
    ...
    public Order(int Order_ID, int Account_ID, int Order_Detail_ID, int Total_Price, String Phone_number, String Delivery_Instruction, String Delivery_Address, Date Delivery_Time, int Payment_Method_ID) {
